...
public class BackendBService implements Service {
    ...
    @CircuitBreaker(name = BACKEND_B, fallbackMethod = "fluxFallback")
    ...
    @TimeLimiter(name = BACKEND_B)
    @Bulkhead(name = BACKEND_B)
    @CircuitBreaker(name = BACKEND_B, fallbackMethod = "monoFallback")
    ...
    @Bulkhead(name = BACKEND_B, type = Type.THREADPOOL)
    @TimeLimiter(name = BACKEND_B)
    @CircuitBreaker(name = BACKEND_B, fallbackMethod = "futureFallback")
